    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="width:500px; height:150px;">
            ...
            <div class="modal-header">
                <h5 class="modal-title ms-2" id="staticBackdropLabel">ログイン</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body d-flex align-items-center justify-content-center">
                <!-- ボタンを表示 -->
                <button id="google-login-button" class="btn btn-block btn-outline-secondary" style="width: 300px; height: 40px;">

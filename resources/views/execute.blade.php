...
@section('body')
            <div class="inline-container">
                ...
                <!--  -->
                <button type="submit" class="btn btn-outline-secondary me-5 mt-3" id="edit-button" style="width: 80px; height: 40px;">編集</button>
                <button type="submit" class="btn btn-outline-secondary me-5 mt-3" id="execute-button" style="width: 80px; height: 40px;">実行</button>
            </div>
            ...
            <div class="inline-container ajust-size1 align-items-stretch mt-2" style="width: 100%; min-height: 0%; max-height: 100%;">
                ...
                <div class="workflow-container me-3">
                    ...
                    <div class="inline-container">
                        <button type="submit" class="btn btn-outline-secondary ms-auto me-3" id="update-button" style="width: 40px; height: 40px;">▷</button>
                    </div>
